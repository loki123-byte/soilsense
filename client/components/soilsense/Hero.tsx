  ...
  return (
    <section className="relative min-h-[88vh] w-full fog-bottom">
      ...
      <div className="relative container flex flex-col items-center justify-center text-center min-h-[88vh]">
        ...
        >
          <Button onClick={onCheckSoil} className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-6 text-base rounded-lg pulse-glow">
            Check Your Soil
          </Button>
          <Button onClick={onOpenChat} variant="secondary" className="bg-secondary hover:bg-secondary/80 text-secondary-foreground px-6 py-6 text-base rounded-lg">
            Chat with AI
          </Button>
        </motion.div>
      </div>
