...
import ESPConnect from "@/components/soilsense/ESPConnect";
import { FeaturesSection, CTASection } from "@/components/soilsense/FeaturesSection";
...
export default function Index() {
  ...
  return (
    <Layout>
      <Hero onCheckSoil={() => navigate('/get-started')} onOpenChat={() => setChatOpen(true)} />
      <Timeline />
